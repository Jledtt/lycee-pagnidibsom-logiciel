...
class StaffRoleWebController extends Controller
{
    ...
    private function permissionGroups(): array
    {
        return [
            ...
            'Professeurs' => [
                'teachers.view' => 'Voir les dossiers professeurs',
                'teachers.manage' => 'Modifier les dossiers professeurs',
                'teacher_attendance.view' => 'Voir les heures effectuées',
                'teacher_attendance.manage' => 'Saisir et valider les heures effectuées',
                'teacher_fees.view' => 'Voir les honoraires',
                'teacher_fees.manage' => 'Préparer les ordres de paiement',
                'teacher_fees.approve' => 'Valider les ordres de paiement',
                'teacher_fees.pay' => 'Enregistrer le paiement des honoraires',
                'teacher_documents.manage' => 'Gérer les pièces des dossiers professeurs',
            ],
            'Communication' => [
    ...
    private function permissionActions(): array
    {
        return [
            ...
            'teachers.view' => 'view',
            'teachers.manage' => 'modify',
            'teacher_attendance.view' => 'view',
            'teacher_attendance.manage' => 'modify',
            'teacher_fees.view' => 'view',
            'teacher_fees.manage' => 'modify',
            'teacher_fees.approve' => 'manage',
            'teacher_fees.pay' => 'modify',
            'teacher_documents.manage' => 'modify',
    ...
    private function roleDescriptions(): array
    {
        return [
            ...
            'direction' => 'Accès global au pilotage, aux opérations, aux finances, aux utilisateurs et aux paramètres.',
