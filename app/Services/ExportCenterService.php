    ...
    public function teacherFeeRows(AcademicYear $academicYear, ?int $mockExamId = null, ?string $feeStatus = null): Collection
    {
        return MockExamSubject::query()
            ...
            ->map(fn (MockExamSubject $examSubject) => [
                ...
                $examSubject->beneficiary_identity_type,
                $examSubject->beneficiary_identity_number,
                $examSubject->calculatedFeeQuantity(),
                $examSubject->fee_quantity_unit,
                $examSubject->fee_rate,
                $examSubject->calculatedFeeGrossAmount(),
                $examSubject->fee_withholding_amount,
                $examSubject->fee_advance_amount,
                $examSubject->fee_other_deduction_amount,
                $examSubject->calculatedFeeNetAmount(),
