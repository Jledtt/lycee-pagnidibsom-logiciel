...
return [
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('LPP_BACKUP_MAIL_TO', env('MAIL_FROM_ADDRESS', 'infoslyceepagnidibsom@gmail.com')),
    ...
    'cleanup' => [
        ...
        'default_strategy' => [
             ...
             */
            'keep_all_backups_for_days' => (int) env('LPP_BACKUP_KEEP_ALL_DAYS', 7),
             ...
             */
            'keep_daily_backups_for_days' => (int) env('LPP_BACKUP_KEEP_DAILY_DAYS', 16),
             ...
             */
            'keep_weekly_backups_for_weeks' => (int) env('LPP_BACKUP_KEEP_WEEKLY_WEEKS', 8),

            /*
             * After the "keep_weekly_backups_for_weeks" period is over, the most recent backup
             * of that month will be kept. Older backups within the same month will be removed.
             */
            'keep_monthly_backups_for_months' => (int) env('LPP_BACKUP_KEEP_MONTHLY_MONTHS', 4),

            /*
             * After the "keep_monthly_backups_for_months" period is over, the most recent backup
             * of that year will be kept. Older backups within the same year will be removed.
             */
            'keep_yearly_backups_for_years' => (int) env('LPP_BACKUP_KEEP_YEARLY_YEARS', 2),
             ...
             */
            'delete_oldest_backups_when_using_more_megabytes_than' => (int) env('LPP_BACKUP_DELETE_WHEN_OVER_MB', 5000),
        ],
