            ...
            $candidates->each(function (MockExamCandidate $candidate, int $candidateIndex) use ($mockExamSubject, $subjectIndex, $isSport) {
                MockExamScore::query()->updateOrCreate(
                    ...
                    [
                        ...
                        'is_absent' => false,
                        'observation' => $isSport && $candidateIndex === 7 ? 'Dispense médicale levée' : null,
                    ],
                );
            });
        });
    ...
    private function studentProfiles(): array
    {
        return [
            [
                ...
                'guardian_profession' => 'Commerçant',
                'guardian_service' => 'Marché de Pagnidibsom',
            ...
            [
                ...
                'guardian_service' => 'École primaire',
            ...
            [
                ...
                'guardian_service' => 'Centre médical',
                'guardian_relationship' => 'mother',
            ],
            [
                'first_name' => 'Estelle',
                ...
                'guardian_service' => 'Entreprise privée',
                'guardian_relationship' => 'father',
            ],
            [
                'first_name' => 'Ousmane',
            ...
            [
                ...
                'health_conditions' => [],
                'sport_aptitude' => true,
                'emergency_name' => 'Thérèse Kinda',
                'emergency_phone' => '71010008',
                'whatsapp' => '76010008',
                'guardian_first_name' => 'Thérèse',
            ...
            [
                ...
                'guardian_service' => 'Société privée',
                'guardian_relationship' => 'father',
            ],
            [
                'first_name' => 'Abdoul',
