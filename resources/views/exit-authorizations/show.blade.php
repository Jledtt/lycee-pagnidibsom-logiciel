@extends('layouts.app', [
    'title' => 'Autorisation - Lycee Prive Pagnidibsom',
...
@section('page_actions')
    ...
    <a class="btn btn-primary" href="{{ route('exit-authorizations.pdf', $authorization) }}" data-download-feedback="Telechargement de l autorisation lance.">PDF</a>
@endsection
    ...
    <section class="grid two-col">
        <div class="panel">
            ...
            <div class="detail-grid">
                ...
                <div class="detail-item"><span>Cree par</span><strong>{{ $authorization->creator?->name ?? '-' }}</strong></div>
            </div>
        </div>
        ...
        <div class="panel">
            ...
            <div class="detail-grid">
                ...
                <div class="detail-item"><span>Matiere concernee</span><strong>{{ $authorization->subject_name ?: '-' }}</strong></div>
