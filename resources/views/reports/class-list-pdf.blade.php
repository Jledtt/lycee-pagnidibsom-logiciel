    ...
    <table class="list">
        <thead>
            <tr>
                ...
                <th style="width:74px">Matricule</th>
                <th>Nom et prénom(s)</th>
                <th style="width:36px" class="center">Sexe</th>
                <th style="width:62px">Naissance</th>
                <th style="width:105px">Tuteur</th>
                <th style="width:82px">Contact</th>
            </tr>
        </thead>
        <tbody>
